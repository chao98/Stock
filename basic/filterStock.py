...
'''
Usage: find out all stock IDs in the input file, and write them into output file
...
def main():
	if len(sys.argv) < 3:
		...
		print('inputfile file contain some stock id or name in textual content, I need to filter them out')
		sys.exit(1)
